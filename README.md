...
1. [Download V1](https://github.com/CreeperGamingDT/Ez-gg-datapack-bots/raw/main/ez-gg-botsv1.zip)  
...
1. [Download V2 (Experimental)](https://github.com/CreeperGamingDT/Ez-gg-datapack-bots/raw/main/ez-gg-botsv2.zip)  
2. Open your Minecraft worlds folder  
3. Open the `datapacks` folder  
4. Drag the downloaded `.zip` file into `datapacks`  
5. Run `/reload` in-game  
